...
- #### 테스트케이스 인수 전달하기   
  ...
  두 괄호 쌍 `((`, `))` 안에, 앞서 작성한 매개변수 자료형과 맞는 인수들을 `,`으로 연결하여 입력합니다.   
  ```c++
  /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
매개변수 자료형의 경우도 마찬가지입니다.

> `float`, `unsigned int`, `array<>`, `vector<vector<vector<>>>` 등 **프로그래머스**에서 사용하지 않거나 사용빈도가 적은 자료형은 지원하지 않습니다.

> 인수 개수 제한은 없으며, `const`, `&`, `*` 사용은 불가능합니다.
